...
Ο Μετασχηματισμός Fouier Διακριτών σημάτων (DSFT) εφαρμόζεται σε σήματα που είναι διακριτά στον πεδίο του χρόνου, αλλά έχει αποτέλεσμα που είναι συνεχές στο πεδίο των συχνοτήτων. Δηλαδή:
- το σήμα είναι διακριτό $f[n]$
- το φάσμα είναι συνεχές: $F(u)$ 
...
Ο διακριτός Μετασχηματισμός Fourier (DFT) εφαρμόζεται σε σήματα που είναι διακριτά και πεπερασμένου μήκους στον χώρο και παράγει φάσμα που επίσης είναι διακριτό στο χώρο της συχνότητας.
...
## Περιοδικότητα εικόνας και κυκλική συνέλιξη
Ο DFT υπονοεί ότι η εικόνα είναι περιοδική:
$$ f(m+kM,n+lN) = f(m,n) $$
Αυτό οδηγεί σε κυκλική συνέλιξη στο χωρικό πεδίο.
Για να υλοποιηθεί γραμμική συνέλιξη μέσω DFT:
- Εφαρμόζεται zero-padding
- διαστάσεις:
  $$ M = M_1 + M_2 - 1,~~ N = N_1 + N_2 - 1 $$
