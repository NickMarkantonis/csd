...
- Προτόκολο *AXI*
  ...
  - 5 Ανεξάρτητα Κανάλια στο AXI
    ...
    - κανάλι δεδομένων ανάγνωσης
      - Μεταφέρει τα δεδομένα και πληροφορίες απόκρισης ανάγνωσης
      - Το data bus μπορεί να έχει πλάτος 8, 16, 32, 64, 128, 256, 512 ή 1024 bits
    - κανάλι δεδομένων εγγραφής
      - Το data bus μπορεί να έχει πλάτος 8, 16, 32, 64, 128, 256, 512 ή 1024 bits
    - κανάλι απόκρισης εγγραφής
      - Μεταφέρει πληροφορίες απόκρισης για την εγγραφή, αν δηλαδή ήταν επιτυχής
  - Μεταβλητές
    - Read
      <p align="center">
  ...
  - Out-of-order Completion
    - Το ΑΧΙ δίνει ένα αναγνωριστικό (ID) σε κάθε συναλλαγή
    - Συναλλαγές με το ίδιο ID πρέπει να ολοκληρώνονται με την σειρά που στάλθηκαν
    - Συναλλαγές με διαφορετικό ID μπορούν να ολοκληρωθούν εκτός σειράς
    - Αυτό μπορεί να αυξήσει την αποδοτικότητα με δύο τρόπους:
      1. **Γρήγοροι slaves**: μπορούν να απαντήσουν νωρίτερα απο άλλους πιο αργούς slaves ακόμα και όταν δεν είναι πρώτοι στην σειρά
      2. **Πιο σύνθετοι slaves**: μπορούν να επιστρέψουν δεδομένα εκτός σειρας, δηλαδή δεδομένα απο μία αργότερη πρόσβαση μπορεί να είναι έτοιμα απο αυτά μίας προηγούμενης
    - Αν ένας master απαιτεί οι συναλλαγές να ολοκληρώνονται με τη σειρά που τις στέλνει, τότε πρέπει να έχουν όλες το ίδιο ID
    - Δεν είναι υποχρεωτικό χαρακτηριστικό
      - Απλοί master και slaves μπορούν να επεξεργάζονται μία συναλλαγή κάθε φο´ρα και με τη σειρά που τις λαμβάνουν
