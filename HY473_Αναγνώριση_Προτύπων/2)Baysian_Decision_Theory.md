...
Αφού όμως το $p(x)$ είναι κοινό μπορούμε να απλοποιήσουμε λίγο τον τύπο:
$$ \begin{align*} g_i(x) &= p(x|\omega_i) \cdot P(\omega_i) \\ g_i(x) &= \ln p(x|\omega_i) + \ln P(\omega_i) \end{align*} $$

> #### Fun Fact
> Ο λόγος που χρησιμοποιούμε τον φυσικό λογάριθμο είναι εφόσον αν το $p(x|\omega_i)$ είναι Γκαουσιανό και έχει μορφή:
> $$ p(x|\omega_i) = \frac{1}{2\pi^{d/2}|\Sigma|^{1/2}} e^{\frac{1}{2}(x-μ_i)^T\Sigma^{-1}(x-μ_i)} $$
> Αυτό μπορεί να πάρει τιμές πολύ μικρός αριθμός και να προκαλέσει numerical underflow όπου στρογγυλοποιήτε σε 0 εφόσον οι υπολλογιστές είναι πεπερασμένης μνήμης. Με την χρήση όμως του $\ln$ που είναι 1-1 και γνησίος αύξουσα συνάρτηση δεν αλλάζουμε το αποτέλεσμα και το $e^{.}$ φέυγει αφήνοντας μόνο τον εκθέτη και έτσι αποφέυγουμε τους πολύ μικρούς αριθμούς.

Κάθε συνάρτηση διαχωρισμού δημιουργεί $c$ περιοχές απόφασης $R_1,...,R_c$ οι οποίες χωρίζονται από επιφάνεις απόφασης που ικανοποιούν:
$$ g_i(x) = g_j(x) $$
